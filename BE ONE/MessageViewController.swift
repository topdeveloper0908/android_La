...
class MessageViewController: UIViewController {
    ...
    @IBAction func Verstuur(_ sender: Any) {
      ...
      let userEmail = "kurt.warson@eyecatch-apps.be"
        ...
        let myUrl = NSURL(string: "https://www.cocoonplace.com/be/userRegisterFMGoud.php")
    ...
    */
    func displayMyAlertMessage(userMessage:String) {
        ...
        var myAlert = UIAlertController(title:"FM Goud", message: userMessage, preferredStyle: UIAlertControllerStyle.alert)
