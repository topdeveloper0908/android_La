...
class ScrollViewController: UIViewController,FRadioPlayerDelegate{
    ...
    @IBOutlet weak var aantalLabel2: UILabel!
    
    @IBOutlet weak var play4Button4: UIButton!
    
  
    @IBOutlet var aantalLabel3: UILabel!
    
    
    @IBOutlet var play5Button5: UIButton!
    
    
    @IBOutlet var aantalLabel4: UILabel!
    
    @IBOutlet var play6Button6: UIButton!
    ...
    //*****************************************************************
    let url1 = URL(string: "https://fmgoud.level27.be/")
    let url2 = URL(string: "https://fmgoudplus.level27.be/")
    let url3 = URL(string: "https://server3.radio-streams.net:18019/stream")
    
      let url4 = URL(string: "https://server3.radio-streams.net:18019/stream")
    
     let url5 = URL(string: "https://server6.radio-streams.net:18007/stream")
    @objc func methodOfReceivedNotification(notification: Notification) {
            
            play4Button4!.setTitle("Play", for: UIControlState.normal)
            self.View2.layer.borderColor = UIColor.white.cgColor
            
            play3Button3!.setTitle("Play", for: UIControlState.normal)
            self.View1.layer.borderColor = UIColor.white.cgColor
        
         play5Button5!.setTitle("Play", for: UIControlState.normal)
                   self.View3.layer.borderColor = UIColor.white.cgColor
        
           play6Button6!.setTitle("Play", for: UIControlState.normal)
                        self.View4.layer.borderColor = UIColor.white.cgColor
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.methodOfReceivedNotification(notification:)), name: Notification.Name("playerFlagNotification1"), object: nil)
        ...
        self.View1.layer.borderColor = UIColor.white.cgColor
         ...
         self.View2.layer.borderWidth = 4
               self.View2.layer.borderColor = UIColor.white.cgColor
        
         self.View3.layer.borderWidth = 4
                      self.View3.layer.borderColor = UIColor.white.cgColor
        
          self.View4.layer.borderWidth = 4
                            self.View4.layer.borderColor = UIColor.white.cgColor
...
//        self.View3.layer.borderColor = UIColor.white.cgColor
        ...
        case .pad:
            ...
            parsedTextResultLabel.font =
                parsedTextResultLabel.font.withSize(13.0)
...
//        NotificationCenter.default.addObserver(self, selector: #selector(internetChanged), name: ReachabilityChangedNotification, object: reachability)
    ...
    @IBAction func facebook3(_ sender: Any) {
        UIApplication.shared.openURL(URL(string: "https://www.facebook.com/fmgoud/")!)
    }
    
    
    @IBAction func publi(_ sender: Any) {
        
          let url = URL(string: "http://www.goudenzaken.be")!
    ...
    @IBAction func phone(_ sender: Any) {
        let url = URL(string:"tel:003211606171")!
        print("Test")
    ...
    func sendEmail() {
        ...
        let mailUrl = URL(string: "mailto:" + "info@fmgoud.be")!
...
//    @IBAction func playButton5(_ sender: Any) {
//        play3Button3!.setTitle("Play", for: UIControlState.normal)
//        play4Button4!.setTitle("Play", for: UIControlState.normal)
//             if reachability.isReachable{
//                 if reachability.isReachableViaWiFi || reachability.isReachableViaWWAN{
//
//                     if !player.isPlaying || player.radioURL != url3
//                     {
//                        player.radioURL = url3
//                         playflag = false
//                         player.stop()
//                         if countdownTimer != nil {
//                             countdownTimer.invalidate()
...
//                         player.play()
//
////                        play5Button5!.setTitle("Stop", for: UIControlState.normal)
...
//    }
    ...
    @IBAction func playButton2(_ sender: Any) {
        ...
        NotificationCenter.default.post(name: Notification.Name("playerFlagNotification2"), object: nil)
        ...
        if reachability.isReachable{
            if reachability.isReachableViaWiFi || reachability.isReachableViaWWAN{
                ...
                if !player.isPlaying || player.radioURL != url2
                {
                    player.radioURL = url2
                    playflag = false
                    player.stop()
                    if countdownTimer != nil {
                        countdownTimer.invalidate()
                    ...
                    playflag = true
                    player.play()
                    play4Button4!.setTitle("Stop", for: UIControlState.normal)
                    self.View2.layer.borderColor = UIColor.orange.cgColor
                     self.View1.layer.borderColor = UIColor.white.cgColor
                    self.View3.layer.borderColor = UIColor.white.cgColor
                ...
                play5Button5!.setTitle("Play", for: UIControlState.normal)
                    ...
                    if reachability.isReachable{
                        if reachability.isReachableViaWiFi || reachability.isReachableViaWWAN{
                            ...
                            if !player.isPlaying || player.radioURL != url5
                            {
                                player.radioURL = url5
                                playflag = false
                                player.stop()
                                if countdownTimer != nil {
                                    countdownTimer.invalidate()
                                ...
                                playflag = true
                                player.play()
                                play6Button6!.setTitle("Stop", for: UIControlState.normal)
                                self.View4.layer.borderColor = UIColor.orange.cgColor
                                 self.View1.layer.borderColor = UIColor.white.cgColor
                                self.View2.layer.borderColor = UIColor.white.cgColor
                             self.View3.layer.borderColor = UIColor.white.cgColor
           ...
           play6Button6!.setTitle("Play", for: UIControlState.normal)
               ...
               if reachability.isReachable{
                   if reachability.isReachableViaWiFi || reachability.isReachableViaWWAN{
                       ...
                       if !player.isPlaying || player.radioURL != url4
                       {
                           player.radioURL = url4
                           playflag = false
                           player.stop()
                           if countdownTimer != nil {
                               countdownTimer.invalidate()
                           ...
                           player.play()
                           play5Button5!.setTitle("Stop", for: UIControlState.normal)
                           self.View3.layer.borderColor = UIColor.orange.cgColor
                            self.View1.layer.borderColor = UIColor.white.cgColor
                           self.View2.layer.borderColor = UIColor.white.cgColor
                        self.View4.layer.borderColor = UIColor.white.cgColor
...
//        play5Button5!.setTitle("Play", for: UIControlState.normal)
        if reachability.isReachable{
            if reachability.isReachableViaWiFi || reachability.isReachableViaWWAN{
                ...
                if !player.isPlaying || player.radioURL != url1
                {
                    player.radioURL = url1
                    playflag = false
                    player.stop()
...
//            play5Button5!.setTitle("Play", for: UIControlState.normal)
    ...
    @IBAction func btnRefreshSelect(_ sender: UIButton?) {
        ...
        stopTimer()
       // if (play4Button4.titleLabel?.text == "Stop"){
            makeGetCall2 { (dic, errorDesc) in
                print("DIC \(dic ?? ["EMPTY" : "EMPTY"])")
                print("ERROR DESC \(errorDesc ?? "NAN")")
                
                // Display on UI
                self.setUIFor2(dic: dic, errorDesc: errorDesc)
     ...
     //   }
           ...
           makeGetCall3 { (dic, errorDesc) in
                 print("DIC \(dic ?? ["EMPTY" : "EMPTY"])")
                 print("ERROR DESC \(errorDesc ?? "NAN")")
                 
                 // Display on UI
                 self.setUIFor3(dic: dic, errorDesc: errorDesc)
                 //            self.showHideCoverView(show: false)
                 self.startTimer()
          //   }
             }
        
         makeGetCall4 { (dic, errorDesc) in
                        print("DIC \(dic ?? ["EMPTY" : "EMPTY"])")
                        print("ERROR DESC \(errorDesc ?? "NAN")")
                        
                        // Display on UI
                        self.setUIFor4(dic: dic, errorDesc: errorDesc)
                        //            self.showHideCoverView(show: false)
                        self.startTimer()
                 //   }
                    }
    ...
    func setUIFor2(dic : [String : Any]?, errorDesc : String?) {
        if let errorDesc = errorDesc {
            //            resultTextView.text = errorDesc
            //            parsedTextStaticLabel.text = "Error Found:"
            aantalLabel2.text = "U bent momenteel offline."
        }else{
            //            resultTextView.text = (dic!["RESPONSE_DATA"] as? String) ?? ""
            let song = (dic!["TEXT"] as? String) ?? ""
            if !String.checkEmpty(song), songName != song{
            ...
            aantalLabel2.text = (dic!["TEXT"] as? String) ?? ""
        }
    }
    
     func setUIFor3(dic : [String : Any]?, errorDesc : String?) {
           if let errorDesc = errorDesc {
               //            resultTextView.text = errorDesc
               //            parsedTextStaticLabel.text = "Error Found:"
               aantalLabel3.text = "U bent momenteel offline."
           }else{
               //            resultTextView.text = (dic!["RESPONSE_DATA"] as? String) ?? ""
               let song = (dic!["TEXT"] as? String) ?? ""
               if !String.checkEmpty(song), songName != song{
               ...
               aantalLabel3.text = (dic!["TEXT"] as? String) ?? ""
           }
       }
    
     func setUIFor4(dic : [String : Any]?, errorDesc : String?) {
              if let errorDesc = errorDesc {
                  //            resultTextView.text = errorDesc
                  //            parsedTextStaticLabel.text = "Error Found:"
                  aantalLabel4.text = "U bent momenteel offline."
              }else{
                  //            resultTextView.text = (dic!["RESPONSE_DATA"] as? String) ?? ""
                  let song = (dic!["TEXT"] as? String) ?? ""
                  if !String.checkEmpty(song), songName != song{
                  ...
                  aantalLabel4.text = (dic!["TEXT"] as? String) ?? ""
              }
          }
