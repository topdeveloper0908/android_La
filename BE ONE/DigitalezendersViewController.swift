...
class DigitalezendersViewController: UIViewController,FRadioPlayerDelegate{
    var playTime = 0
    ...
    @IBOutlet weak var play5Button5: UIButton!
    
    
    @IBOutlet weak var play6Button6: UIButton!
    ...
    //*****************************************************************
    let url1 = URL(string: "https://dinoradio.level27.be/")
    
     let url2 = URL(string: "http://streams.movemedia.eu:8330/")
//    let url2 = URL(string: "http://streams.movemedia.eu:8330/listen.pls")
    
    let url3 = URL(string: "http://public.radio.co/stations/sb5d2bfbdb/m3u")
    let url4 = URL(string: "http://public.radio.co/stations/s5709ea2c0/m3u")
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.methodOfReceivedNotification1(notification:)), name: Notification.Name("playerFlagNotification2"), object: nil)
...
//        NotificationCenter.default.addObserver(self, selector: #selector(internetChanged), name: ReachabilityChangedNotification, object: reachability)
    ...
    @IBAction func eyecatch(_ sender: Any) {
        
          let url = URL(string: "http://www.eyecatch-apps.be")!
    ...
    @IBAction func playButton6(_ sender: Any) {
        
        NotificationCenter.default.post(name: Notification.Name("playerFlagNotification1"), object: nil)
...
extension DigitalezendersViewController : UIPickerViewDataSource, UIPickerViewDelegate{
...
extension DigitalezendersViewController {
