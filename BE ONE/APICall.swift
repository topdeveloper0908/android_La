...
func makeGetCall(complete : @escaping (_ dic : [String : Any]?, _ errorDesc : String?) -> Void) {
    ...
    let nowplayingEndpoint: String = "https://ftp.fmgoud.be/RDS/nowplaying_CL1.txt"
...
func makeGetCall2(complete : @escaping (_ dic : [String : Any]?, _ errorDesc : String?) -> Void) {
    UIApplication.shared.isNetworkActivityIndicatorVisible = true
    // Set up the URL request
    let nowplayingEndpoint: String = "https://ftp.fmgoud.be/RDS/nowplaying_CL2.txt"
    guard let url = URL(string: nowplayingEndpoint) else {
        print("Error: cannot create URL")
        return
    }
...
func makeGetCall3(complete : @escaping (_ dic : [String : Any]?, _ errorDesc : String?) -> Void) {
    UIApplication.shared.isNetworkActivityIndicatorVisible = true
    // Set up the URL request
    let nowplayingEndpoint: String = "https://ftp.fmgoud.be/RDS/nowplaying_CL3.txt"
    guard let url = URL(string: nowplayingEndpoint) else {
        print("Error: cannot create URL")
        return
    }
...
func makeGetCall4(complete : @escaping (_ dic : [String : Any]?, _ errorDesc : String?) -> Void) {
    UIApplication.shared.isNetworkActivityIndicatorVisible = true
    // Set up the URL request
    let nowplayingEndpoint: String = "https://ftp.fmgoud.be/RDS/nowplaying_CL4.txt"
    guard let url = URL(string: nowplayingEndpoint) else {
        print("Error: cannot create URL")
        return
    }
