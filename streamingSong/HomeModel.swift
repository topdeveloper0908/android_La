...
class HomeModel: NSObject, URLSessionDataDelegate {
    ...
    let urlPath: String = "http://www.cocoonplace.com/be/serviceKompas.php"
    ...
    func parseJSON() {
        ...
        do {
            ...
            for i in 0  ..< jsonResult.count
            {
                ...
                location.name = jsonElement["Name"] as? String ?? ""
                 location.beschrijving = jsonElement["beschrijving"] as? String ?? ""
                location.address = jsonElement["Address"] as? String ?? ""
                location.latitude = jsonElement["Latitude"] as? String ?? ""
                location.longitude = jsonElement["Longitude"] as? String ?? ""
                location.imagename = jsonElement["imagename"] as? String ?? ""
                   location.beschrijving = jsonElement["Beschrijving"] as? String ?? ""
                location.song = jsonElement["song"] as? String ?? ""
                  location.datum = jsonElement["Datum"] as? String ?? ""
